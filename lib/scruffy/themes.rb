...
module Scruffy::Themes
  ...
  class Base
    ...
    attr_accessor :data_marker_font_size
    attr_accessor :value_marker_font_size
    ...
    def initialize(descriptor)
      ...
      self.data_marker_font_size = descriptor[:data_marker_font_size]
      self.value_marker_font_size = descriptor[:value_marker_font_size]
    end
